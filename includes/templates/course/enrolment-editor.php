			...
			<ul class="tutor-ul dtlms-sidebar-meta-info">
				<?php foreach ( $sidebar_meta as $key => $meta ) : ?>
					...
					<li class="tutor-d-flex<?php echo $key > 0 ? ' tutor-mt-12' : ''; ?>">
						<span class="<?php echo esc_attr( $meta['icon_class'] ); ?> tutor-mt-4 tutor-color-black tutor-mr-12 dtlms-enrollment-meta-label" aria-labelledby="<?php echo esc_html( $meta['label'] ); ?>"></span>
