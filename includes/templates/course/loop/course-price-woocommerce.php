...
if ( tutor_utils()->is_course_purchasable( $course_id ) ) {
	$enroll_btn = '<a href="/" data-quantity="1" class="tutor-btn tutor-btn-outline-primary tutor-btn-md tutor-btn-block  product_type_simple add_to_cart_button  ajax_add_to_cart"><span class="tutor-icon-cart-line tutor-mr-8"></span><span class="cart-text">' . __( 'Add to cart', 'tutor' ) . '</span></a>';
