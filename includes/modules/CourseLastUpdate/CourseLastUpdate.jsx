...
class CourseLastUpdate extends Component {
    ...
    template (props) {
        if(!props.__lastupdate.is_disable) {
            return (
                <div className="tutor-single-course-meta-last-update">
                    <label> { props.update_label } </label>
                    <span>
                        { props.__lastupdate.last_update }
                    </span>
                </div>                
            );
        } else {
    ...
    static css(props) {
        ...
        const wrapper = '%%order_class%% .tutor-single-course-meta-last-update';
