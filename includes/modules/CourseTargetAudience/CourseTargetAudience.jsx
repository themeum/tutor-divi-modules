...
class CourseTargetAudience extends Component {
    ...
    static css(props) {
        const additionalCss = [];
        //selectors
        const wrapper = '%%order_class%% .tutor-course-target-audience-wrap';
        const li_selector = '%%order_class%% .tutor-course-target-audience-wrap li';
		const icon_selector	= "%%order_class%% .tutor-course-target-audience-wrap li .et-pb-icon";
