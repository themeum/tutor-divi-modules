...
class CourseWishlist extends ET_Builder_Module {
	...
	public static function get_content( $args = array() ) {
		...
		<a href="#" class="action-btn tutor-course-wishlist-btn tutor-text-regular-body tutor-color-text-primary tutor-d-flex tutor-align-items-center" data-course-id="<?php echo get_the_ID(); ?>">
