...
class TutorCourseRequirements extends ET_Builder_Module {
	...
	public function init() {
		// Module name & icon
		$this->name      = esc_html__( 'Tutor Course Requirements', 'tutor-lms-divi-modules' );
	...
	public function get_fields() {
		$fields = array(
			...
			'label'          => array(
				...
				'type'            => 'text',
				'default'         => esc_html__( 'Requirements', 'tutor-lms-divi-modules' ),
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		ET_Builder_Element::set_style(
			...
			array(
				'selector'    => $wrapper . ' ul',
				'declaration' => 'padding: 0px !important; list-style:none !important;',
			)
		);
