...
class TutorCourseMaterials extends ET_Builder_Module {
	...
	public function init() {
		// Module name & icon
		$this->name      = esc_html__( 'Tutor Course Materials', 'tutor-lms-divi-modules' );
	...
	public function get_fields() {
		$fields = array(
			...
			'label'         => array(
				'label'           => esc_html__( 'Material Label', 'tutor-lms-divi-modules' ),
				'type'            => 'text',
				'default'         => esc_html__( 'Material Includes', 'tutor-lms-divi-modules' ),
	...
	public static function get_props( $args = array() ) {
		...
		$props     = array(
			'materials' => is_array( $materials ) && count( $materials ) ? $materials : 0,
		);
		return $materials;
	}
